...
int main(int argc, const char * argv[]) {
    NSMutableString *strM = [NSMutableString stringWithFormat:@"www.520it.com520520"];
    
    // 1.在字符串后面添加/image
//    [strM appendFormat:@"/image"];
////    [strM appendFormat:@"/age = %i", 10];
//    NSLog(@"strM = %@", strM);
...
//    NSLog(@"newStr = %@", newStr);
    ...
    NSUInteger count = [strM replaceOccurrencesOfString:@"520" withString:@"250" options:0 range:NSMakeRange(0, strM.length)];
    NSLog(@"strM = %@", strM);
