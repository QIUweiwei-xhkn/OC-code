...
int main(int argc, const char * argv[]) {
    ...
    NSString *str2 = [[NSString alloc] initWithFormat:@"q"];
    NSString *str22 = [[NSString alloc]initWithFormat:@"q"];
    NSLog(@"str2 = %p, str22 = %p", str2, str22);
    
    //3.通过类工厂方法创建/ stringWithFormat
    //内部其实就是封装了alloc init
    NSString *str3 = [NSString stringWithFormat:@"ww"];
    NSString *str33 = [NSString stringWithFormat:@"ww"];
    ...
    */
    NSString *str4 = [[NSString alloc]initWithString:@"w"];
    NSString *str44 = [[NSString alloc]initWithString:@"w"];
